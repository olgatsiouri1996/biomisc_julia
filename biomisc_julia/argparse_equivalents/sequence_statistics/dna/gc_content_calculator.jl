...
function parse_commandline()
    ...
    s = ArgParseSettings(description = "calculate the %GC content of a multi or single fasta file and outputs in a tabular format by selecting max and min %AT thresholds")
