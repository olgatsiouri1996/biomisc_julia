...
function parse_commandline()
    ...
    s = ArgParseSettings(description = "calculate the %GC content of a multi or single fasta file and output in a tabular format with ids  by selecting max and min %GC thresholds")
