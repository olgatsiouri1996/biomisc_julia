...
# main
print("calculate the %AT content of a multi or single fasta file and outputs in a tabular format by selecting max and min %AT thresholds\nusage: julia select_header_by_at.jl input_fasta min_at max_at output_txt")
