...
function parse_commandline()
    ...
    s = ArgParseSettings(description = "retrieves the CpG islands and exports the id, start, end, gc content and obs/exp ratio")
...
# create function for gc content calculation
    ...
    open(parsed_args["out"],"a") do io
        println(io,"id","\t","start","\t","end","\t","%GC","\t","obs","\t","obs/exp")
    end
