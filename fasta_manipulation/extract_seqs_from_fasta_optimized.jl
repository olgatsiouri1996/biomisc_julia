...
function parse_commandline()
    ...
    s = ArgParseSettings(description = "extract fasta records from a multi-fasta file by using a txt file with fasta identifiers with an input index fai file for bigger speed")
