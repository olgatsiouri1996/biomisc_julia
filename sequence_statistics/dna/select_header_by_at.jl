...
function parse_commandline()
    ...
    s = ArgParseSettings(description = "calculate the %AT content of a multi or single fasta file and outputs in a tabular format with ids and description by selecting max and min %AT thresholds")
